                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0">{{ $company->full_name }}</h4>
                                        ...
                                        <div class="d-flex flex-column h-100">
                                            ...
                                            <h3 class="mb-0 mt-auto"><span class="counter-value" data-target="3652">0</span>
                                                <small class="text-success fs-xs mb-0 ms-1"><i
                                                        class="bi bi-arrow-up me-1"></i> 06.19%</small>
                                            </h3>
                                        </div>
                                    </div>
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="d-flex flex-column h-100">
                                            ...
                                            <h3 class="mb-0 mt-auto"><span class="counter-value" data-target="1524">0</span>
                                                <small class="text-success fs-xs mb-0 ms-1"><i
                                                        class="bi bi-arrow-up me-1"></i> 02.33%</small>
                                            </h3>
                                        </div>
                                    </div>
                                    <div class="flex-shrink-0">
                                        ...
                                        <div class="d-flex flex-column h-100">
                                            ...
                                            <h3 class="mb-0 mt-auto"><span class="counter-value" data-target="2376">0</span>
                                                <small class="text-danger fs-xs mb-0 ms-1"><i
                                                        class="bi bi-arrow-down me-1"></i> 09.57%</small>
                                            </h3>
                                        </div>
                                    </div>
                                    <div class="flex-shrink-0">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col-lg-3">
                                        <div class="nav flex-column nav-light nav-pills gap-3" id="v-pills-tab"
                                            role="tablist" aria-orientation="vertical">
                                            <a class="nav-link d-flex p-2 gap-3 active" id="revenue-tab"
                                                data-bs-toggle="pill" href="#revenue" role="tab"
                                                aria-controls="revenue" aria-selected="true">
                                            ...
                                            <a class="nav-link d-flex p-2 gap-3" id="property-sale-tab"
                                                data-bs-toggle="pill" href="#property-sale" role="tab"
                                                aria-controls="property-sale" aria-selected="false">
                                                <div class="avatar-sm flex-shrink-0">
                                    ...
                                    <div class="col-lg-9">
                                        <div class="tab-content text-muted">
                                            ...
                                            <div class="tab-pane" id="property-sale" role="tabpanel">
                                                <div id="property_sale_chart" data-colors='["--tb-danger"]'
...
@section('js')
    ...
    <script src="{{ asset('dashboard') }}/assets/js/pages/dashboard-real-estate.init.js"></script>
@endsection
